	...
	public VentanaCarta(String ruta, JFrame va) {
		...
		btnAnyadirCarrito.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BD.aniadirProductoAlCarrito(VentanaLogin.getNick(), ruta, BD.obtenerNombreCarta(ruta),
						BD.obtenerEdicionCarta(ruta), BD.obtenerRarezaCarta(ruta), BD.obtenerPrecioCarta(ruta));
				JOptionPane.showMessageDialog(null, "La Carta se ha añadido al carro", "Añadido al Carro",
