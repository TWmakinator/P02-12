...
public class BD {
	...
	private static Exception lastError = null;  // Informaci贸n de 煤ltimo error SQL ocurrido
		...
		try {
			...
			try {
				statement.executeUpdate("create table usuario " +
					"(nick string, contrase帽a string, email string, NumeroCuenta int)");
	...
	/** Devuelve la informaci贸n de excepci贸n del 煤ltimo error producido por cualquiera 
	 * de los m茅todos de gesti贸n de base de datos
	 */
	 ...
	 *           1: Si el nick es correcto pero la contrase帽a no
	 *           2: Si el nick y la contrase帽a son correctos
